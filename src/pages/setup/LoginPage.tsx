  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0f0f10] px-6 py-10">
      <div className="w-full max-w-xl rounded-2xl border border-white/[0.06] bg-[#131314] p-6 shadow-2xl shadow-black/25">
        <div className="mb-6">
          <div className="mb-2 text-[11px] font-semibold uppercase tracking-wider text-[#918f90]">MissionOS Login</div>
          <h1 className="text-2xl font-semibold text-white">Sign in</h1>
          <p className="mt-2 text-[13px] text-[#918f90]">Authenticate with your local MissionOS account.</p>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            >
              {mission.busyKey === "auth:login" ? "Signing in..." : "Login"}
            </button>
          </div>
        </form>
      </div>
